...
que valores demasiado pequeños producen una convergencia lenta. Por esta razón, la elección adecuada de $lr$ 
es importante para un correcto funcionamiento del algoritmo.

La actualización se realiza de elemento a elemento sobre los tensores de parámetros, 
permitiendo trabajar con escalares, vectores, matrices o tensores de mayor dimensión mediante operaciones 
vectorizadas. Como resultado, se obtiene un nuevo conjunto de parámetros que busca reducir el valor de la 
